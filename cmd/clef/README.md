...
GLOBAL OPTIONS:
   ...
   --chainid value         Chain id to use for signing (1=mainnet, 3=Ropsten, 4=Rinkeby, 5=Stormborn) (default: 1)
...
In this case, `aegon` would be started with `--signer http://localhost:8550` and would relay requests to `eth.sendTransaction`.
