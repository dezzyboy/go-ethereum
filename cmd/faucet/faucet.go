...
var (
	...
	stormbornFlag = flag.Bool("stormborn", false, "Initializes the faucet with Stormborn network config")
...
func main() {
	...
	genesis, err := getGenesis(*genesisFlag, *stormbornFlag, *rinkebyFlag, *sepoliaFlag)
	if err != nil {
...
func getGenesis(genesisFlag string, stormbornFlag bool, rinkebyFlag bool, sepoliaFlag bool) (*core.Genesis, error) {
	switch {
	case genesisFlag != "":
		...
		return &genesis, err
	case stormbornFlag:
		return core.DefaultStormbornGenesisBlock(), nil
	case rinkebyFlag:
