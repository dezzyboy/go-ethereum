...
# 1. install aegon for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for aegon
# 5. create aegon, attach and uninstall start menu entries
...
function .onInit
  # make vars are global for all users since aegon is installed global
