...
// that address/topic, and binary AND-ing those vectors toaegoner.
	...
	go func() {
		...
		for {
			...
			case subres, ok := <-process:
				...
				// Gather all the sub-results and merge them toaegoner
				var orVector []byte
...
// the requested retrieval queue to be serviced toaegoner with other sessions.
//
